...
import { Waypoints, Plug, Database, Network, FileText, LayoutDashboard, Regex } from 'lucide-react';
...
export type AppMode = 'canvas' | 'playground' | 'sql' | 'erd' | 'regex' | 'reports' | 'dashboards';
