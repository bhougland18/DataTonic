...
COMPONENTS = {
    ...
    'src.http': {
        ...
        'params': ['url', 'method', 'body', 'headers', 'connectionRef', 'transportRef', 'authType', 'authToken', 'authHeader', 'tokenUrl', 'clientId', 'clientSecret', 'clientAuth', 'scope', 'responsePath', 'jsonPath', 'paginationType', 'cursorNextPath', 'cursorParam', 'offsetParam', 'pageSize', 'totalCountPath', 'pageParam', 'startPage', 'maxPages', 'responseMetadata', 'rawResponseDestination', 'hasHeader', 'delimiter', 'quoteChar', 'encoding', 'skipLines', 'nullValue', 'nullPadding', 'ignoreErrors', 'readOptions', 'recordsPath', 'flatten', 'keepParentNames'],
    },
    'src.hubspot': {
        'kind': 'source',
    ...
    'src.sap.rfc': {
        ...
        'params': ['url', 'method', 'body', 'headers', 'connectionRef', 'transportRef', 'authType', 'authToken', 'authHeader', 'tokenUrl', 'clientId', 'clientSecret', 'clientAuth', 'scope', 'responseFormat', 'responsePath', 'jsonPath', 'paginationType', 'nextUrlPath', 'cursorNextPath', 'cursorParam', 'offsetParam', 'pageSize', 'totalCountPath', 'pageParam', 'startPage', 'maxPages', 'incrementalField', 'incrementalInitial', 'responseMetadata', 'rawResponseDestination'],
    },
    'src.scylla': {
        'kind': 'source',
